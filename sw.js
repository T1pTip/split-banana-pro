...
// Version: v2.2 | fixed paths from /palette-ai-v2/ to /palette-ai/
const CACHE = 'palette-ai-v2.2';
const ASSETS = ['/palette-ai/', '/palette-ai/index.html', '/palette-ai/manifest.json', '/palette-ai/pae-v2-module.js', '/palette-ai/pae-video-module.js'];
